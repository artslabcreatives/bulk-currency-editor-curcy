...
|
*/
if (class_exists('\BulkCurrencyEditorCURCY\WPBones\Foundation\Plugin')) {
    $plugin = new \BulkCurrencyEditorCURCY\WPBones\Foundation\Plugin(
        realpath(__DIR__ . '/../')
    );
    ...
    */
     ...
     */
    do_action('bulk-currency-editor-curcy_loaded');
