...
<div class="bulk-currency-editor-curcy wrap">
	<h1><?php echo $plugin->Name ?>: Edit Product Regular Prices</h1>
						...
						<div class="card-body">
							<?php foreach ($currencies as $curre) {?>
								<div class="form-group">
									...
									<input step="any" type="number" class="form-control" name="bulk[<?php echo $curre; ?>]" placeholder="Enter <?php echo $curre; ?> Amount">
